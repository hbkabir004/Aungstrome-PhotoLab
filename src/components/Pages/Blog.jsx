            ...
            <div className="grid gap-5 lg:grid-cols-2 sm:max-w-sm sm:mx-auto lg:max-w-full">
                <div className="overflow-hidden transition-shadow duration-300 bg-white rounded p-5 dark:bg-gray-900">
                    ...
                    <div className="py-5">
                        ...
                        >
                            <p className="dark:text-white text-2xl font-bold leading-5 dark:hover:text-deep-purple-accent-700">Difference between SQL and NoSQL</p>
                        </a>
                        ...
                        <div className="flex space-x-4">
                            ...
                            >
                                ...
                                <p classname="font-semibold dark:text-white">5.2K</p>
                            </a>
                            <a
                                href="/"
                                aria-label="Comments"
                ...
                <div className="overflow-hidden transition-shadow duration-300 bg-white rounded p-5 dark:bg-gray-900">
                    ...
                    <div className="py-5">
                        ...
                        <a
                            ...
                            className="inline-block mb-3 text-black transition-colors duration-200 hover:text-deep-purple-accent-700"
                        >
                            <p className="dark:text-white text-2xl font-bold leading-5 dark:hover:text-deep-purple-accent-700">What is JWT, and how does it work?</p>
                        </a>
                        <p className="mb-4 text-gray-700 dark:text-white">
                ...
                <div className="overflow-hidden transition-shadow duration-300 bg-white rounded p-5 dark:bg-gray-900">
                    ...
                    <div className="py-5">
                        ...
                        <a
                            ...
                            className="inline-block mb-3 text-black transition-colors duration-200 hover:text-deep-purple-accent-700"
                        >
                            <p className="text-2xl dark:hover:text-deep-purple-accent-700 font-bold leading-5 dark:text-white ">What is the difference between javascript and NodeJS?</p>
                        </a>
